...
String times=print_time(now);
Serial.print(times);
String path = "/SeizurePatients";
...
int i,j,k;
i=analogRead(A0);
if ((i>=20 && i<=55) && (Ax>=-1.0 && Ax<=1.0) && (Ay>=-1.0 && Ay<=1.0) && (Az>=-1.0 && Az<=1.5)){

    json1.set("sreyans01@gmail com/EMG", 1);
    }
else {
  
    json1.set("sreyans01@gmail com/EMG", 0);
}
